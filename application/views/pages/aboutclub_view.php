...
<br><br><br>
        ...
        <div class="span6">
    <div class="well">
          <h2>IT CLUB HOW IT WORKS </h2>
      <hr/>
          <p><i class="icon-tags"></i> To improve manpower skill through technical Training</p>
      <br/>
           <p><i class="icon-tags"></i> Decisions on New technology and problems through Seminars</p>
      <br/>
       <p><i class="icon-tags"></i>  To Aware New technology and solves problems through Webinars </p>
      <br/>
      </div>
        </div>
        ...
        <div class="span6">
    <div class="well">
          <h2>IT CLUB FOR WHOM</h2>
      <hr/>
          <p><i class="icon-flag"></i>  Information Technology Students.</p>
          <br/>
      <p><i class="icon-flag"></i> Information Technology Professional and Practitioner</p>
      <br/>
      <p><i class="icon-flag"></i> Information Technology Companies</p>
      <br/>
      <p><i class="icon-flag"></i> Information Technology Companies</p>
       </div></div>
